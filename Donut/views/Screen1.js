...
const data = [
  {
    ...
    desc: "Order a Large Pizza but the size is the equivalent of a medium small from other places at the same price range.",
    price: "10",
  },
  {
    id: "2",
...
export default function App({ navigation }) {
  ...
  const renderItems = ({ item }) => (
    ...
    >
      ...
      >
        ...
        >
          <Text style={{ fontSize: 45, fontWeight: 400, color: "#fff" }}>
            +
          </Text>
        </Pressable>
      </View>
  ...
  return (
    <View style={{ padding: 10, flex: 1 }}>
      <View
        style={{ height: "30%", width: "100%", justifyContent: "space-around" }}
      >
        ...
        >
          <Pressable
            style={[
              ...
              {
                backgroundColor:
                  selectedButton === "Donut" ? "#F1B000" : "#fff",
              },
            ]}
            onPress={() => {
          ...
          <Pressable
            style={[
              ...
              {
                backgroundColor:
                  selectedButton === "Pink Donut" ? "#F1B000" : "#fff",
              },
            ]}
            onPress={() => {
          ...
          <Pressable
            style={[
              ...
              {
                backgroundColor:
                  selectedButton === "Green Donut" ? "#F1B000" : "#fff",
              },
            ]}
            onPress={() => {
